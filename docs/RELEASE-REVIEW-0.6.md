...
| V06-MT-01.V3 | open - decision pending | Default warmup + five-trial run not yet captured; G-05 recorded three-trial runs. Candidate to execute in the next packaged window. |
...
| V06-MT-10.V3 | open - decision pending | The 10k ranking latency (1.88 s release) is recorded; worst-case response size for the retained candidate limit is not separately measured. |
| V06-DC-12.I4 | open - to execute | Frontend alignment and packaged cancellation semantics are recorded (FE-11 + G-05 cancel evidence); the shared write-mutex/seek measurement remains to run. |
