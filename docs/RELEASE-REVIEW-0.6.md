...
| V06-G-05.V1 | checked | Re-bind executed twice (2026-09-12): first at `272ae15`, then at the final `57bde64e` after the MT-06 fix; the packaged set (supervision, seven-stage health, default v2, tamper, FE-16/FE-05 walks, IPC-01.V2, MT-05, churn, witnesses), `verify_041` (25/25) and the lifecycle runs are all bound to the final candidate and its digests. |
