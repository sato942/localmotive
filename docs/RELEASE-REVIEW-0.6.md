...
Owner-gated and environment items are unchanged: tag creation/push, publication/promotion, rulesets, the hosted PR campaign, SignPath, the three-vendor RT-06 host, the MT-07 physical-hardware program and the two native sandbox reruns.
