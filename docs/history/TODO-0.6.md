...
#### S-27 progress record — slices 1-3b: catalog, runtime, server and measurement facades + About screen (I1/I2 remain)
...
- REMNANTS in I1 (explicit): the cloud/OAuth and tuning command bodies still live in `lib.rs`; next slice = the tuning family (the last of the job-lifecycle owners).
