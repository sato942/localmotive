...
| R07 | Preservation canaries are generic fixtures, not real v0.4.1/v0.5.0 persisted data; release.yml requests only v0.4.0 | V06-G-06.I2 (reopened below), GH-04.I3 | **Open — in progress** | See “Reopened claims” below. Requires v0.4.1/v0.5.0 real persistence fixtures (schemas provable from the released revisions) and an expanded lifecycle baseline set. |
