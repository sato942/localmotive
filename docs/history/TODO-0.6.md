...
#### S-27 progress record — slices 1-3d: five Rust facades + About and Runtime screens (I1 complete; I2: Tune screen remains)
...
- REMNANTS in I2 (explicit): the Tune screen with its typed operation state and the remaining acquisition hooks still live in `App.tsx`; next slice = the Tune screen.
