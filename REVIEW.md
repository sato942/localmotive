...
| REL-11 | High | REFUTED 2026-09-25 (P1-11) | Generated lab JavaScript is hardcoded and DOM-text fragile | `.github/workflows/release.yml:271-289`, `329-382`, `421-449`. |
...
| LAB-03 | High | VERIFIED 2026-09-25 (P1-11) | Three independent CDP clients guarantee behavior drift | `scripts/lib/cdp_client.mjs:32-149`; `scripts/verify_041.mjs:139-237`; `scripts/drive_console_check.mjs:20-60`. |
...
| LAB-05 | High | VERIFIED 2026-09-25 (P1-11) | Operational coverage is scattered across dead one-off drivers and source-only tests | reference table; source-only assertions `scripts/tests/release-gates.test.mjs:2021-2031`; active direct lab calls `.github/workflows/rele... |
| LAB-06 | High | REFUTED 2026-09-25 (P1-11) | Catalog validation is a two-language copy with an unchecked output-shape gap | `scripts/lib/catalog_schema.mjs:1-8,63-160`; `src-tauri/src/catalog.rs:362-428`; `scripts/build_catalog.mjs:230-248`; `catalog/catalog.js... |
...
| DOC-05 | High | REFUTED 2026-09-25 (P1-11) | Three support authorities disagree about 0.6 evidence | `README.md:327-341`; `docs/EVIDENCE-MATRIX.md:3-8,21-28`; `docs/SUPPORT-MATRIX.md:18-33`. |
...
| DOC-07 | High | REFUTED 2026-09-25 (P1-11) | The release ledger has expanded into a 111-package, 663-checkbox control system | `REPORT-0.6.md:12-20`; `docs/history/TODO-0.6.md:13-25`; `TODO.md:30-169`. |
...
| RT-04 | High | VERIFIED 2026-09-25 (P1-11) | The execution lease pins expected files but not the directory inventory | `src-tauri/src/runtime.rs:4139-4160`, `4090-4126`, and managed health `4783-4791`. |
...
| RT-07 | High | REFUTED 2026-09-25 (P1-11) | Managed-runtime discovery crosses reparse ancestors and has no scan bound | `src-tauri/src/runtime.rs:992-996`, `1102-1164`; caller `src-tauri/src/runtime_service.rs:17-27`. |
| RT-10 | High | VERIFIED 2026-09-25 (P1-11) | Path validation is inconsistent and sometimes happens after the first write | `src-tauri/src/runtime.rs:2679-2696`, `4489-4498`, `4630-4636`, `4680-4689`. |
| CORE-03 | High | REFUTED 2026-09-25 (P1-11) | An abandoned tuning command can release ownership while its blocking worker keeps running | `src-tauri/src/tune_service.rs:244-266,361-371`; `src-tauri/src/server_service.rs:26-32`; `src-tauri/src/lib.rs:250-269,4217-4234`. |
...
| CORE-05 | High | VERIFIED 2026-09-25 (P1-11) | Several IPC payloads are typed but not bounded before allocation or expensive work | `src-tauri/src/lib.rs:1479-1502,1557-1569,1574-1583,1639-1669,1854-1882`; `src-tauri/src/core.rs:642,1272-1274,1432-1456`; `src-tauri/src... |
| PROC-02 | High | VERIFIED 2026-09-25 (P1-11) | Failed process cleanup can turn a bounded operation into an unbounded pipe-reader join | `src-tauri/src/proc.rs:35–50, 423–480` |
| PROC-03 | High | VERIFIED 2026-09-25 (P1-11) | Timeout and cancellation return success-shaped errors even when termination failed | `src-tauri/src/proc.rs:357–391, 427–471` |
| PROC-04 | High | VERIFIED 2026-09-25 (P1-11) | Startup can leave the `starting` slot permanently occupied | `src-tauri/src/server_service.rs:104–122` |
| PROC-05 | High | VERIFIED 2026-09-25 (P1-11) | Health readiness uses a redirect-following transport path | `src-tauri/src/health.rs:1082–1155`; comparison: `src-tauri/src/local_client.rs:509–517` |
| PROC-06 | High | VERIFIED 2026-09-25 (P1-11) | Health cancellation abandons an untracked nested request worker | `src-tauri/src/health.rs:659–713, 715–747` |
| PROC-07 | High | VERIFIED 2026-09-25 (P1-11) | Transport-file reads do not enforce reparse/no-follow semantics at the read site | `src-tauri/src/local_client.rs:854–876`; launch validation comparison: `src-tauri/src/lib.rs:722–739` |
| PROC-08 | High | VERIFIED 2026-09-25 (P1-11) | Secondary log handles and failure evidence follow a replaced path | `src-tauri/src/log_sink.rs:100–111, 203–217` |
| DL-01 | High | VERIFIED 2026-09-25 (P1-11) | Mutable SQLite override rows are accepted as download authority without read-time revalidation | `src-tauri/src/lib.rs:2010-2044`; `src-tauri/src/catalog_db.rs:727-777` |
| DL-03 | High | VERIFIED 2026-09-25 (P1-11) | Reparse/symlink validation is separated from the file open | `src-tauri/src/artifact.rs:277-302`; `src-tauri/src/gguf.rs:649-657` |
| DL-04 | High | VERIFIED 2026-09-25 (P1-11) | OAuth key exchange buffers an unbounded response | `src-tauri/src/cloud.rs:596-616` |
| MT-01 | High | VERIFIED 2026-09-25 (P1-11) | Heuristic in-sample repeat is presented as confirmation | `src-tauri/src/tune.rs:976-982, 1551-1649`; `src/screens/TuneScreen.tsx:344-349`; `src-tauri/src/measurement.rs:14, 19-28`. |
| MT-03 | High | VERIFIED 2026-09-25 (P1-11) | Warmup-only failure cannot produce the promised saved manifest | `src-tauri/src/measurement.rs:342-390`; `src-tauri/src/evidence.rs:756-823`; `src-tauri/src/measurement_service.rs:537-550`; `src/V03Evid... |
| MT-05 | High | VERIFIED 2026-09-25 (P1-11) | Cold benchmark removes the managed server and does not restore it | `src-tauri/src/measurement_service.rs:613-688, 689-733`; `src/V03EvidencePanel.tsx:591-598`. |
| MT-06 | High | VERIFIED 2026-09-25 (P1-11) | Worker-drain failure can reserve the benchmark slot forever | `src-tauri/src/measurement_service.rs:28-42, 709-723`; `src-tauri/src/local_client.rs:677-737`. |
| MT-07 | High | REFUTED 2026-09-25 (P1-11) | Tuner cancellation releases its operation while its legacy HTTP worker may continue | `src-tauri/src/tune_service.rs:25-101, 228-365`; `src-tauri/src/core.rs:2325-2345`; `src-tauri/src/local_client.rs:677-737`. |
| MT-08 | High | VERIFIED 2026-09-25 (P1-11) | Unknown execution identity is recorded but ignored by replay | `src-tauri/src/measurement_service.rs:242-268, 286-317, 792-807`; `src-tauri/src/calibration.rs:81-84`; `src-tauri/src/evidence.rs:637-644`. |
| MT-09 | High | VERIFIED 2026-09-25 (P1-11) | Shipped legacy benchmark is weaker and duplicates v2 | `src-tauri/src/measurement_service.rs:52-129, 603-734`; `src-tauri/src/core.rs:2240-2346`; `src/screens/BenchmarkScreen.tsx:45-76`; `src/... |
...
| FE-04 | High | VERIFIED 2026-09-25 (P1-11) | `App` is a controller, persistence service, async coordinator, and shell renderer in one component | `src/App.tsx:87-164,170-359,362-755,757-1028,1030-1239,1243-1501,1503-1858`. |
| FE-05 | High | VERIFIED 2026-09-25 (P1-11) | Legacy benchmark and “v2” evidence are two active product systems, not one migrated feature | `src/App.tsx:173-177,259,1301-1333`; `src/screens/BenchmarkScreen.tsx:43-86`; `src/V03EvidencePanel.tsx:126,572-580`; `src/App.staleRespo... |
| FE-06 | High | VERIFIED 2026-09-25 (P1-11) | The presentation boundary is contradicted by a direct screen IPC call and untyped adapter calls | `src/screens/InventoryScreen.tsx:1-13,51-58`; `src/evidence-adapter.ts:18-43`. |
